...
- Eval manual e dataset padrão de recuperação em `/workspace/documents`, `/api/documents/retrieval-evals` e `src/lib/documents/retrieval-eval-dataset.json`.
