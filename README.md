...
Decidir próximo incremento após edição básica de documentos: embeddings reais, parsing avançado/PDF ou melhoria de UX/QA documental.
...
Checkpoint atual: o trabalho está sincronizado até TASK 036. A v0.1-beta já permite cadastrar e editar fontes com conteúdo bruto, importar arquivos textuais, reprocessar chunks, buscar trechos com ranking lexical/local, gerar embeddings mock por chunk, usar recuperação híbrida no chat mock e validar recuperação com evals versionados.
