...
import { searchVectorDocumentChunks } from "@/lib/documents/vector-search";
...
export async function GET(request: Request) {
  ...
  try {
    const results = await searchVectorDocumentChunks(query);
    ...
    const message =
      error instanceof Error ? error.message : "Busca vetorial indisponivel.";
